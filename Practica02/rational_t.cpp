...
//Sobrecarga del operador multiplicador (*)
rational_t operator*(const rational_t& a, const rational_t& b) {
...
// E/S
//Método que permite imprimir por pantalla un número racional
void rational_t::write(ostream& os) const {
  os << get_num() << "/" << get_den() << "=" << value() << endl;
}

//Método que permite leer un número racional
